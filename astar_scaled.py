...
def solve(heuristic, number):
    ...
    for index, puzzle in enumerate(puzzles):
        ...
        first_node = f_node_scaled.FNodeScaled(puzzle, heuristic)
        search_filename = f'output_scaled/{index}_astar-h{number}_search.txt'
